...
// FR-5 / M3 DoD:
// Both lead POST endpoints are limited to 5 requests/minute/IP.
//
// The limiter is created per app/router (see lead.routes),
// so every app instance gets its own in-memory counter.
